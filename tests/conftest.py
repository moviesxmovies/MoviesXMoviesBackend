...
MOVIE_LIST_WRAPPER_URL = '/api/movies-lists/{username}/{movies_list_slug}/'
...
USER_TRANSLATIONS_URL = '/api/users/{username}/translations/'
...
PERSON_SEARCHING_URL = '/api/persons/searching/'
